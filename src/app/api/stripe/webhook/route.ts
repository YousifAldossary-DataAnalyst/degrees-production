...
export async function POST(req: NextRequest) {
  ...
  //Live when we come to production.
  const webhookSecret =
  ...
  //The if function !subscription.metadata because we are testing in local env.
  //two different end-point -> one for production and one for connected account payment
  //Therefore in production you need to create another end-point -> Accept payments for the subaccount and agency subscriptions.
  try {
