  ...
  return (
    <Sheet open={true} modal={false}>
      <Tabs className="w-full " defaultValue="Settings">
        ...
        {/* Rendering the tabs from the list above */}
        <SheetContent
          showX={false}
          side="right"
          className={clsx(
          ...
          <div className="grid gap-4 h-full pb-36 overflow-auto">
            ...
            <TabsContent value="Layers">
              <SheetHeader className="text-left p-6 ">
                ...
                <SheetDescription>
                  Sort Layers like a structure
                  {/* Dome represntation in a tree Structure, focus on the element being clicked and move it around
                  , checkout previous lessons in funnel pages and pipelines section*/}
                </SheetDescription>
                <LayersTab/>
              </SheetHeader>
