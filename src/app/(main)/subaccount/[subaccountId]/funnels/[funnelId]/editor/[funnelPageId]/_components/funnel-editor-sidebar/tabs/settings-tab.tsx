...
const SettingsTab = (props: Props) => {
  ...
  // You only need two handlers to manage Accordion items
  ...
  return (
    ...
    >
    {/* Creating an accordion input field, this example is a link component*/}
    <AccordionItem
        value="Custom"
        className="px-6 py-0  "
      >
        <AccordionTrigger className="!no-underline">Links</AccordionTrigger>
        <AccordionContent>
      ...
      {/* this is another example for a vidoe component*/}
      <AccordionItem
        value="Video"
        className="px-6 py-0  "
      >
        <AccordionTrigger className="!no-underline">Video</AccordionTrigger>
        <AccordionContent>
          {state.editor.selectedElement.type === 'video' &&
            !Array.isArray(state.editor.selectedElement.content) && (
              <div className="flex flex-col gap-2">
                <p className="text-muted-foreground">Link Path:<br/> Make sure to add: https://youtube.com/embed/... </p>
                <Input
                  id="src"
                  placeholder="https://youtube.com/embed/ByLI4xGr38Y?si=20ozSC04UFnTqOFm"
                  onChange={handleChangeCustomValues}
                  value={state.editor.selectedElement.content.href}
                />
              </div>
      ...
      >
        ...
        {/* Challenge Try adding more fonts -> hints font weight and mapping through weights*/}
      <AccordionItem
        value="Typography"
      ...
      >
        ...
        <AccordionContent className="flex flex-col gap-2 ">
          <div className="flex flex-col gap-2 ">
            ...
            {/* The id is the property we want to change */}
            <Tabs
              onValueChange={(e) =>
                handleOnChanges({
                  target: {
