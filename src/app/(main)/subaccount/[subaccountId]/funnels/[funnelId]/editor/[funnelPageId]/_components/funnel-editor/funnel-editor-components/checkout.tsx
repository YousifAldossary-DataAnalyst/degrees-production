...
const Checkout = (props: Props) => {
  ...
  //when the component render -> create clientSecret -> [livePrices, subaccountId, subAccountConnectAccId]
  useEffect(() => {
    if (livePrices.length && subaccountId && subAccountConnectAccId) {
      const getClientSercet = async () => {
        //Create body object by converting all of this into JSON
        try {
          ...
          //Send the JSON Details above to api input
  ...
  // you can wire it up if you want to. You don't need it.
