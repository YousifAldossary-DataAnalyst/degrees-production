...
const FunnelSettings: React.FC<FunnelSettingsProps> = async ({
  ...
  //CHALLENGE: go connect your stripe to sell products -> this will be covered in dashboards use that.
...
//This was not working because there is no account connected.
//WIP open on deploy
