...
//Challenge: add resume and cancel subscription from stripe -> hint: Look at how to listen to subscription to add resume and cancel button.
//Look at creating and updating subscription similar functionality but use it to add a button to resume and to cancel -> Check webhook 
      ...
      <div className="flex flex-col gap-4">
        {data.plans?.plans.map((price) => (
          ...
          >
            <CardHeader>
              <CardTitle>
                {price.unit_amount ? price.unit_amount / 100 : '0'} SAR
