...
import InfoBarSupport from './infobar-support'
...
const InfoBar = ({ notifications, subAccountId, className, role }: Props) => {
  ...
  return (
    <>
      <div
        className={twMerge(
          'fixed z-[20] md:left-[300px] left-0 right-0 top-0 p-2 bg-background/80 backdrop-blur-md flex gap-4 items-center border-b-[1px] ',
          className
        )}
      >
        <InfoBarSupport/>
        <div className="flex items-center ml-auto flex flex-row justify-end gap-6 px-4 w-full">
