  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-20 bg-gradient-to-br from-neutral-500 to-neutral-600 dark:from-slate-300 dark:to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Plans That
        <br /> Fit You Best
      </motion.h1>
