...
import AutomationOptions from "../global/automation-sidebar";
        ...
        <div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                className="w-full my-4 flex items-center justify-between py-8 overflow-hidden"
                variant={"ghost"}
              >
          ...
          <nav className="relative">
            <Command className="rounded-lg overflow-visible bg-transparent">
              ...
              <CommandList className="py-4 overflow-visible">
                <CommandEmpty>No Results Found</CommandEmpty>
                <CommandGroup className="overflow-visible w-100%">
